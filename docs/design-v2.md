...
```javascript
// 待办 -> 习惯
function convertTodoToHabit(todoId, timeRule) {
...
| 页面名称 | 文件名 | 说明 |
|---------|---------|------|
| 今日待办 | todo.html | 临时任务管理，支持优先级、分类、搜索 |
